...
export const enMessages = {
  ...
  stock: {
    ...
    noSearchMatchesTitle: 'No matches',
    noSearchMatchesDescription: 'No items match “{search}”. Try a different name, brand, or SKU.',
    stats: {
    ...
    add: {
      ...
      description: 'Create a new inventory item. SKU must be unique within your practice.',
      category: 'Category',
      name: 'Name',
      brand: 'Brand',
      spec: 'Spec',
      specPlaceholder: 'e.g. 52-18-140',
      sku: 'SKU',
    ...
    delete: {
      ...
      description: 'This permanently removes {name} ({sku}) from your inventory.',
      confirm: 'Delete item',
